...
function SignupForm() {
    ...
    const validationSchema = Yup.object().shape({
        ...
        password: Yup.string().required("Password is required").min(8, "Password is too short - should be 6 chars minimum"),
        confirm_password: Yup.string().required("Password is required").min(8, "Password is too short - should be 6 chars minimum"),
    });
                    ...
                    <Form className="">
                        <div className="Auth-form-content">
                            ...
                            <div className="form-group mt-3">
                                ...
                                <Field type="text" className="form-control mt-1" id="first_name" name="first_name"
                                ></Field>
                                <ErrorMessage name="first_name" component='span' className="error"></ErrorMessage>
                            </div>
                            <div className="form-group mt-3">
                                <label htmlFor="last_name">Last name</label>
                                <Field type="text" className="form-control mt-1" id="last_name" name="last_name"
                                ></Field>
                                <ErrorMessage name="last_name" component='span' className="error"></ErrorMessage>
                            </div>
                            <div className="form-group mt-3">
                            ...
                            <div className="form-group mt-3">
                                ...
                                <Field type="password" className="form-control mt-1" name="confirm_password"
                                       id="confirm_password"></Field>
                                <ErrorMessage name="confirm_password"   component='span' className="error"></ErrorMessage>
                            </div>
